...
#define LLSEC_CIPHER_IMPL_encrypt								Java_com_is2t_support_security_cipher_NativeCipherSpi_nativeEncrypt
#define LLSEC_CIPHER_IMPL_close									Java_com_is2t_support_security_cipher_NativeCipherSpi_nativeClose
#define LLSEC_CIPHER_IMPL_get_close_id							Java_com_is2t_support_security_cipher_NativeCipherSpi_nativeGetCloseId
