...
/**
 * This class allows to compute the 32 bit Cyclic Redundancy Check of a data
 * stream.
 */
public class CRC32 {
	private int crc;
	...
	/**
	 * Updates the value of the CRC32 using the provided array of bytes.
	 *
	 * @param bytes
	...
	public void update(byte[] bytes, int offset, int length) {
		...
		for (int i = offset; i < offset + length; i++) {
			crc = (crc >>> NUM_BITS_PER_BYTE) ^ table[(crc ^ bytes[i]) & 0xff];
		}
	}
